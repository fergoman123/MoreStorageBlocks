...
public class ItemBlockBone extends ItemBlockMSB
{

    public ItemBlockBone(Block block) {
        super(ModBlocks.blockBone);
    }

    @Override
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean extraInfo) {
        list.add(NameHelper.translateToLocal(Names.OreDict.oreDictName));
        list.add(NameHelper.translateToLocal(Names.OreDict.blockBone));
    }
}
