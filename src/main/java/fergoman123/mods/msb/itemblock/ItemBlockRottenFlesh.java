 ...
 */
public class ItemBlockRottenFlesh extends ItemBlockMSB {

    public ItemBlockRottenFlesh(Block block) {
        super(ModBlocks.blockRottenFlesh);
    }

    @Override
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean extraInfo) {
        list.add(translateToLocal(odn.oreDictName));
        list.add(translateToLocal(odn.blockRottenFlesh));
    }
}
