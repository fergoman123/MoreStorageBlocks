...
/**
 * Created By Fergoman123 on 26/09/2014 08:17
 */
public class ItemBlockBlazeRod extends ItemBlockMSB
{
    public ItemBlockBlazeRod(Block block) {
        super(ModBlocks.blockBlazeRod);
    }
