...
public class ItemBlockSugarcane extends ItemBlockMSB
{
    public ItemBlockSugarcane(Block block)
    {
        super(ModBlocks.blockSugarcane);
    }

    @Override
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean extraInfo) {
        list.add(NameHelper.translateToLocal(Names.OreDict.oreDictName));
        list.add(NameHelper.translateToLocal(Names.OreDict.blockSugarcane));
    }
}
