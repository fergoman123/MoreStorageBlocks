...
public class ItemBlockFeather extends ItemBlockMSB
{
    public ItemBlockFeather(Block block)
    {
        super(ModBlocks.blockFeather);
    }

    @Override
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean extraInfo) {
        list.add(NameHelper.translateToLocal(Names.OreDict.oreDictName));
        list.add(NameHelper.translateToLocal(Names.OreDict.blockFeather));
    }
}
